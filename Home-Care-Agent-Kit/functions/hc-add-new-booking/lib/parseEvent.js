...
/**
 * Normalises Genesys Cloud Functions (Node.js) and similar HTTP/Lambda-style events into a flat input object.
 * Genesys often passes tool/action fields on the event root — those are merged last so they win.
 */
